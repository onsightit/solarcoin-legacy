...
// Testnet
static const int LAST_POW_BLOCK = 10000; // testnet
...
static const int FORK_HEIGHT_1 = 10020;
static const int FORK_HEIGHT_2 = 10030;
...
static const unsigned int MAX_TX_COMMENT_LEN_V1 = 140; // SolarCoin:  128 bytes + little extra
...
public:
    ...
    std::string ToStringShort() const
    {
        return strprintf(" out %s %s", FormatMoney(nValue).c_str(), scriptPubKey.ToString().c_str());
    }
...
public:
    ...
    */
    ...
    {
        if (a.nVersion == CTransaction::LEGACY_VERSION_2 || b.nVersion == CTransaction::LEGACY_VERSION_2)
    ...
    bool GetStakeTime(CTxDB& txdb, uint64_t& nStakeTime, CBlockIndex* pindexPrev) const;  // SolarCoin: get transaction staketime
